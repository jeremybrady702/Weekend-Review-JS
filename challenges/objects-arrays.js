...
const universities = [];
graduates.forEach((names) => {
  universities.push(names.university);
...
*/
const lowerPopulation = zooAnimals.filter((animalPop) => {
...
*/
const populationTotal = zooAnimals.reduce((runningTotal, currentValue) => {
